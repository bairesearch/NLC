...
string generatePropertyListName(const string propertyClassName)
{
	#ifdef NLC_NONOO
...
string generateActionListName(const string actionClassName)
{
	#ifdef NLC_NONOO
...
string generateActionIncomingListName(const string actionClassName)
{
	#ifdef NLC_NONOO
...
string generateActionSubjectListName(const string actionSubjectClassName)
{
	#ifdef NLC_NONOO
...
string generateActionObjectListName(const string actionObjectClassName)
{
	#ifdef NLC_NONOO
...
string generateEntityListName(const NLCitem* entityParam)
{
...
string generateCodeEntityListDefinitionTypeText(const string entityClassName, const int progLang)
{
...
string generateCodeConditionListDefinitionTypeText(const string conditionClassName, const string conditionObjectClassName, const int progLang)
{
...
string generateReinterpretCastOfVectorReference(const string vectorName, const string castClassName, const int progLang)
{
...
string generateGenericStringMapListName(const string genericListNameStart, const string genericListAppendName)
{
...
{
	string declareNewDecimalPointerVariableText = generatePointerTypeText(generateClassName(NLC_CLASS_DEFINITIONS_GENERIC_LIBRARY_ENTITY_CLASS_TITLE), progLang) + STRING_SPACE + param1->name + progLangEquals[progLang] + progLangNullPointer[progLang] + progLangEndLine[progLang];			 //const NLCgenericEntityClass* param1 = NULL;
	return declareNewDecimalPointerVariableText;
}
