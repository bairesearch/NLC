...
#endif
static string progLangTemplateHeaderPart1[NLC_NUMBER_OF_PROGRAMMING_LANGUAGES] = {"template <class ", "template <class ", "template <class ", "template <class ", "template <class ", "template <class ", "template <class "};
