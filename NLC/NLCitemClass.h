 ...
 * Project Version: 1l16b 08-November-2014
...
#define NLC_ITEM_TYPE_FUNCTION_DECLARATION_ARGUMENT_FUNCTION_OWNER (14)
#endif
#define NLC_ITEM_TYPE_FUNCTION_DECLARATION_ARGUMENT_FUNCTION_OBJECT (15)
#define NLC_ITEM_TYPE_FUNCTION_DECLARATION_ARGUMENT_INSTANCE_OR_CLASS_LIST (16)	//this has not yet been implemented but needs to be
...
#endif
#define NLC_ITEM_TYPE_FUNCTION_DEFINITION_ARGUMENT_FUNCTION (17)
#define NLC_ITEM_TYPE_FUNCTION_DEFINITION_ARGUMENT_FUNCTION_OWNER (18)
#define NLC_ITEM_TYPE_FUNCTION_DEFINITION_ARGUMENT_FUNCTION_OBJECT (19)
#define NLC_ITEM_TYPE_FUNCTION_DEFINITION_ARGUMENT_INSTANCE_OR_CLASS_LIST (20)
