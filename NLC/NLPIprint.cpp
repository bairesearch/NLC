...
bool printClassDefinitions(vector<NLPIclassDefinition *> * classDefinitionList, int progLang, string * code)
{
	...
	{	
		...
		if(!(classDefinition->actionOrConditionInstanceNotClass))
		{
		#endif
...
{
	string conditionListName = conditionClass + conditionObjectClass + NLPI_ITEM_TYPE_CONDITIONLISTVAR_APPENDITION;
