					...
					{	
						...
						for(int i=0; i<numberOfVariables; i++)
						{
							...
							else
							{
								...
								else if((variableValue.length() >= 3) && (variableValue[0] == NLC_USE_MATH_OBJECTS_ADVANCED_VALUE_DELIMITER) && (variableValue[variableValue.length()-1] == NLC_USE_MATH_OBJECTS_ADVANCED_VALUE_DELIMITER))
								{
