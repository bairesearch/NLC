...
{
	vector<NLCgenericEntityClass*>* actionList = getVectorListByName(&(entity->actionListAll), actionName);
	return actionList;
}
...
void addEnumPropertyGeneric(NLCgenericEntityClass* entity, NLCgenericEntityClass* propertyEntity, vector<NLCgenericEntityClass*>* propertyList)
{
	...
	if(enumTypeTablePropertiesIter != enumTypeTableProperties.end())
	{
		...
		entity->enumPropertyLists[propertyEntity->enumType].insert(pair<string, vector<NLCgenericEntityClass*>*>(propertyEntity->name, propertyList));
		//entity->enumPropertyLists.insert(pair<string, unordered_map<string, vector<NLCgenericEntityClass*>*>> (propertyEntity->enumType, pair<string, vector<NLCgenericEntityClass*>*> (propertyEntity->name, propertyList)));
	}
}
...
void addEnumConditionGeneric(NLCgenericEntityClass* entity, NLCgenericEntityClass* condition, NLCgenericEntityClass* conditionObject, unordered_map<NLCgenericEntityClass*, NLCgenericEntityClass*>* conditionList) 
{
	...
	if(enumTypeTableConditionsIter != enumTypeTableConditions.end())
	{
		...
		entity->enumConditionLists[condition->enumType].insert(pair<pair<string, string>*, unordered_map<NLCgenericEntityClass*, NLCgenericEntityClass*>*>(new pair<string, string>(condition->name, conditionObject->name), conditionList));
		//entity->enumConditionLists.insert(pair<string, pair<pair<string, string>*, unordered_map<NLCgenericEntityClass*, NLCgenericEntityClass*>*>>(condition->enumType, pair<pair<string, string>*, unordered_map<NLCgenericEntityClass*, NLCgenericEntityClass*>*>(new pair<string, string>(condition->name, conditionObject->name), conditionList)));
	}
}
